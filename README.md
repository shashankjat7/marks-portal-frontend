This repo is for the front end of marksPortal app and is created using react. The front end was just made but not connected to the backend due to lack of time. But api gateways were made in the backend to access data using REST framework. Here are some api gateways from the app deployed on heroku.
